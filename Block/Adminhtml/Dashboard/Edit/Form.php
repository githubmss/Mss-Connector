<?php
namespace Mss\Connector\Block\Adminhtml\Dashboard\Edit;

class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    public function __construct(//@codingStandardsIgnoreStart
        \Magento\Backend\Block\Template\Context $context,
        \Magento\Framework\Registry $registry,
        \Magento\Framework\Data\FormFactory $formFactory,
        \Magento\Cms\Model\Wysiwyg\Config $wysiwygConfig,
        \Magento\Catalog\Model\ResourceModel\Category\CollectionFactory $categoryCollection,
        \Mss\Connector\Model\Status $options,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'index'    => 'image',
                'renderer' => '\Mss\Connector\Block\Adminhtml\Grid\Renderer\LogoImage',
    ...
    public function getCategoryCollection()
    {
        ...
        return $result;//@codingStandardsIgnoreEnd
    }
}
