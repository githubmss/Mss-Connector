...
class ChangePassword extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($this->customerSession->isLoggedIn()) {
            ...
            $oldpassword = $this->_oldPasswordDecode();
            $newpassword = $this->_newPasswordDecode();
    ...
    private function _oldPasswordDecode()
    {
        //@codingStandardsIgnoreStart
        return base64_decode($this->request->getParam('oldpassword'));
        //@codingStandardsIgnoreEnd
    }

    private function _newPasswordDecode()
    {
        //@codingStandardsIgnoreStart
        return base64_decode($this->request->getParam('oldpassword'));
        //@codingStandardsIgnoreEnd
